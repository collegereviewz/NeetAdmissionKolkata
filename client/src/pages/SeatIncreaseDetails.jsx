...
const SeatIncreaseDetails = () => {
    ...
    const formatType = (typeStr) => {
        if (!typeStr) return 'All India Counseling - PG Medical';
        return typeStr.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
    };

    const title = type ? (type === 'all-india-pg-medical' ? 'All India Counseling - PG Medical' : formatType(type)) : 'All India Counseling - PG Medical';
            ...
            <div className="flex-none flex flex-col gap-2 mb-2">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
                    <div className="flex items-center gap-3">
                        <button onClick={() => navigate('/seat-increase')} className="p-1 rounded-full hover:bg-gray-200 transition-colors">
                            <ArrowLeft size={20} className="text-gray-600" />
                        </button>
                        <h1 className="text-xl font-bold text-gray-900">Seat Increase</h1>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="bg-yellow-100 border border-yellow-200 text-yellow-800 px-2 py-1 rounded-md text-[10px] flex items-center gap-1.5 font-medium">
                            <Info size={12} />
                            Read this before looking at the Seat Increase
                        </div>
                ...
                <table className="min-w-full divide-y divide-gray-200 text-[11px] text-left">
                    <thead className="bg-gray-100 sticky top-0 z-10 shadow-sm border-b border-gray-200">
                        <tr>
                            ...
                            <th className="px-3 py-2 font-bold text-gray-800 uppercase tracking-wider whitespace-nowrap bg-gray-100 sticky top-0">Seats From</th>
                            <th className="px-3 py-2 font-bold text-gray-800 uppercase tracking-wider whitespace-nowrap bg-gray-100 sticky top-0">Seats To</th>
                            <th className="px-3 py-2 font-bold text-gray-800 uppercase tracking-wider whitespace-nowrap bg-gray-100 sticky top-0">Increase</th>
                        </tr>
                    </thead>
                            ...
                            {loading ? (
                                ...
                                data.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-3 py-2 text-gray-700 font-bold">{item.seatsFrom}</td>
                                        <td className="px-3 py-2 text-gray-700 font-bold">{item.seatsTo}</td>
                                        <td className="px-3 py-2 text-green-600 font-bold">+{item.increase}</td>
                                    </motion.tr>
                                ))
                            )}
                        </AnimatePresence>
                ...
                {selectedCollege && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-white rounded-xl shadow-xl w-full max-w-5xl overflow-hidden flex flex-col max-h-[90vh] overflow-y-auto"
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                {/* Cards Layout as per screenshot */}
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="bg-white border border-red-100 rounded-lg p-5 flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] text-gray-500 uppercase tracking-wide font-semibold mb-1">SEATS FROM</p>
                                                <p className="text-gray-900 font-bold text-2xl">{selectedCollege.seatsFrom || '0'}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-white border border-red-100 rounded-lg p-5 flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] text-gray-500 uppercase tracking-wide font-semibold mb-1">SEATS TO</p>
                                                <p className="text-gray-900 font-bold text-2xl">{selectedCollege.seatsTo || '0'}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-white border border-red-100 rounded-lg p-5 flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] text-gray-500 uppercase tracking-wide font-semibold mb-1">INCREASE</p>
                                                <p className="text-gray-900 font-bold text-2xl">{selectedCollege.increase || '0'}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default SeatIncreaseDetails;
