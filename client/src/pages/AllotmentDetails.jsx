            ...
            <div className="flex-none flex flex-col gap-2 mb-2">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
                    <div className="flex items-center gap-3">
                        <button onClick={() => navigate('/allotments')} className="p-1 rounded-full hover:bg-gray-200 transition-colors">
                            <ArrowLeft size={20} className="text-gray-600" />
                        </button>
                        <h1 className="text-xl font-bold text-gray-900">Allotments</h1>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="bg-yellow-100 border border-yellow-200 text-yellow-800 px-2 py-1 rounded-md text-[10px] flex items-center gap-1.5 font-medium">
                            <Info size={12} />
                            Read this before looking at the Allotments
                        </div>
                ...
                <table className="min-w-full divide-y divide-gray-200 text-[11px] text-left">
                    <thead className="bg-gray-100 sticky top-0 z-10 shadow-sm border-b border-gray-200">
                        <tr>
                            ...
                            <th className="px-3 py-2 font-bold text-gray-800 uppercase tracking-wider whitespace-nowrap bg-gray-100 sticky top-0">AI Rank</th>
                            ...
                            {loading ? (
                                ...
                                data.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-3 py-2 whitespace-nowrap text-gray-700 font-medium">{item.round}</td>
                                        <td className="px-3 py-2 whitespace-nowrap text-gray-700 font-bold">{item.aiRank}</td>
