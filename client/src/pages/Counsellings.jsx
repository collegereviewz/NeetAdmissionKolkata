...
import { Search, Scale, ChevronDown, Landmark } from 'lucide-react';
...
const Counsellings = ({ selectedCourse }) => {
    ...
    const config = getFeatureConfig(currentField, 'counsellings');
        ...
        <div className="min-h-screen bg-gray-50 p-4 md:p-8 font-sans">
            <div className="max-w-7xl mx-auto">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
                    <h1 className="text-xl font-bold text-gray-900 text-center mb-6">Counsellings</h1>
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mb-4">
                        <div className="relative group">
                            ...
                            >
                                <option value="">Counselling Type</option>
                        ...
                        <div className="relative group">
                            ...
                            >
                                <option value="">State / Authority</option>
                    ...
                    <div className="text-center text-xs text-gray-400 font-medium">
                        {loading ? 'Searching...' : `${counsellings.length} Counsellings found`}
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        <AnimatePresence>
                            {counsellings.map((counselling, index) => (
                                <motion.div
                                    key={counselling._id || index}
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3 className="text-xs font-medium text-gray-800 mb-1 truncate" title={counselling.counsellingName}>
                                            {counselling.counsellingName}
                                        </h3>
