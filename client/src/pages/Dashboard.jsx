      ...
      <div className="relative group/nav mb-6">
        ...
        >
          ...
          <motion.button 
            ...
            className={`flex items-center px-4 py-2 rounded-full text-sm font-semibold shadow-sm border whitespace-nowrap transition-all cursor-pointer ${
              activeTab === 'home' 
          ...
          {pinnedItems.map((item) => (
             <motion.div 
               ...
               whileHover={{ scale: 1.05 }}
               whileTap={{ scale: 0.95 }}
               className={`relative group flex items-center px-4 py-2 border rounded-full text-sm font-medium transition-all whitespace-nowrap cursor-pointer ${
                 activeTab === item
                  ...
                  <div className="hidden group-hover:flex items-center space-x-2 mr-2">
                    ...
                    <button
                      ...
                      className={`w-4 h-4 flex items-center justify-center rounded-full transition-colors cursor-pointer ${
                        activeTab === item ? 'bg-white/20 text-white hover:bg-white/40' : 'bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600'
                      }`}
                    ...
                    {[
                      {
                        ...
                        title: 'Pointers for All India Stray Round Choice Filling | NEET PG - 2025',
                      },
                      {
                        type: 'note',
                        date: 'Tue, 17 Feb',
                      ...
                      },
                      {
                        ...
                        date: 'Mon, 19 Jan',
                        category: 'All India Counseling - PG Medical',
                        title: 'All India Counselling Round 3 | NEET PG 2025',
                        subtitle: 'All India Counselling Round 3 - How Conversion Happens?',
                        hasVideo: true,
                      },
                      {
                        type: 'note',
                      ...
                      },
                      {
                        ...
                        date: 'Mon, 2 Feb',
                        category: 'All India Counseling - PG Medical',
                        title: 'All India Counselling - MCC Round 3 - For Candidates who did not lock choices',
                        hasDownload: true,
                      },
                    ].map((update, index) => {
                      const colorMap = {
          ...
          >
            ...
            >
                  ...
                  <div className="flex bg-gray-100/80 p-1 rounded-xl items-center shadow-inner border border-gray-200">
                    {['ROUND 1', 'ROUND 2', 'ROUND 3', 'STRAY ROUND'].map((round) => (
                      <motion.button
                        ...
                        className={`px-4 py-2 rounded-lg text-[10px] font-black transition-all uppercase tracking-tighter ${
                          selectedRound === round 
              ...
              <div className="p-10 md:p-16 overflow-x-auto no-scrollbar bg-white">
                <div 
                  className={`flex items-start min-w-max relative pb-12 mx-auto ${
                    roadmapData[selectedRound]?.length <= 4 ? 'max-w-4xl justify-around' : 'justify-start space-x-0'
                  }`}
                >
                  ...
                  {roadmapData[selectedRound]?.map((milestone, idx) => {
                    ...
                    return (
                      ...
                      >
                        {/* Status Label (Top) */}
                        <div className={`mb-8 text-[9px] font-black tracking-[0.2em] uppercase py-1.5 px-4 rounded-full transition-all border shadow-sm flex-shrink-0 whitespace-nowrap z-20 ${
                          isCompleted ? 'bg-green-50/50 text-green-600 border-green-100' : 
                        ...
                        {/* Date */}
                        <div className={`mb-5 text-[10px] md:text-sm font-black transition-all px-2 py-1 rounded-md h-6 flex items-center justify-center z-20 ${
                        ...
                        <div className="relative z-20 flex items-center justify-center mb-8 h-12 w-12 bg-white rounded-full">
                          <motion.div
                            ...
                            className={`w-12 h-12 rounded-full flex items-center justify-center shadow-xl border-4 border-white transition-all duration-500 ${
                        ...
                        <div className={`px-4 text-[13px] font-extrabold leading-snug max-w-[180px] transition-colors duration-300 z-20 ${
